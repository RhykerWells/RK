...
var (
	sessionAllColumns            = []string{"id", "user_id", "token_hash", "expires_at", "created_at"}
	sessionColumnsWithoutDefault = []string{"user_id", "token_hash", "expires_at"}
	sessionColumnsWithDefault    = []string{"id", "created_at"}
...
func (sessionL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSession any, mods queries.Applicator) error {
	var slice []*Session
	var object *Session
